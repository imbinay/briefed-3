...
class QuizAbilityScorer {
  static const _outcomeVerbs = {
    ...
    'breaks', 'sets', 'signs', 'passed', 'approved', 'announced', 'revealed',
    'confirmed', 'arrested', 'released', 'died', 'opens', 'closes', 'cuts',
    'raises', 'hits', 'named', 'found', 'charged', 'acquitted', 'suspended',
    'sacked', 'resigned', 'struck', 'defeated', 'achieved', 'reached',
    'secured',
  };
