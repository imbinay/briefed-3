...
class NewsArticle {
  ...
  factory NewsArticle.fromJson(Map<String, dynamic> json) {
    return NewsArticle(
      ...
      sourceName:  (json['source_name'] ?? json['source_id']  ?? 'News').toString().replaceAll('_', ' '),
      category:    () {
                     final cat = json['category'];
                     const known = {'world', 'technology', 'business', 'sports', 'entertainment'};
                     const skip  = {'top', 'trending', 'latest', 'breaking', 'domestic', 'other'};
                     if (cat is List) {
